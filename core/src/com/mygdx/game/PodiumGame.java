...
public class PodiumGame extends ApplicationAdapter {
	...
	AnimatablePositionedTexture korona;
	AnimatablePositionedTexture napisBoczny;
...
//198,245
	...
	public void create () {
		...
		korona = new AnimatablePositionedTexture("korona.png",377,93);
		napisBoczny = new AnimatablePositionedTexture("napis_boczny.png", 723,287);
