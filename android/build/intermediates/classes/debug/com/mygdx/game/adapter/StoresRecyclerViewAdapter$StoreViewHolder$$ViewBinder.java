...
public class StoresRecyclerViewAdapter$StoreViewHolder$$ViewBinder<T extends com.mygdx.game.adapter.StoresRecyclerViewAdapter.StoreViewHolder> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131492989, "field 'mStoreName'");
    target.mStoreName = finder.castView(view, 2131492989, "field 'mStoreName'");
    view = finder.findOptionalView(source, 2131492990, null);
    target.mSecondLine = finder.castView(view, 2131492990, "field 'mSecondLine'");
  }
